...
@section('title', 'Edit Jenis Kendaraan - Sistem Parkir')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Jenis Kendaraan</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('flat_rate') is-invalid @enderror"
                                    id="flat_rate" name="flat_rate" value="{{ old('flat_rate', $vehicleType->flat_rate) }}"
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                    value="1" {{ old('is_active', $vehicleType->is_active) ? 'checked' : '' }}>
